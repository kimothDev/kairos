...
describe('Thompson Sampling - Beta Distribution', () => {
    describe('sampleBeta', () => {
        ...
        it('should return higher values on average when alpha > beta', () => {
            ...
            const highAvg = highAlphaSamples.reduce((a, b) => a + b, 0) / highAlphaSamples.length;
            const lowAvg = lowAlphaSamples.reduce((a, b) => a + b, 0) / lowAlphaSamples.length;
        ...
        it('should have high variance with low alpha and beta', () => {
            ...
            // Should have decent number in both tails
            expect(below03).toBeGreaterThan(200);
            expect(above07).toBeGreaterThan(200);
        });
    });
});
...
describe('Context Key', () => {
    describe('createContextKey', () => {
        ...
        it('should be case-sensitive', () => {
            expect(createContextKey('Coding', 'high')).not.toBe(createContextKey('coding', 'high'));
        });
    });
});
